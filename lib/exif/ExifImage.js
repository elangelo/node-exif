...
ExifImage.prototype.ProcessExifData = function(bytes)
{
    ...
    {
        console.log('let\'s fetch the thumbnail');

        self.exifData.thumbnail = bytes.slice(this.exifData.thumbnailinfo[ExifImage.TAGS.exif[0x0201]], this.exifData.thumbnailinfo[ExifImage.TAGS.exif[0x0202]]);
    }
}
